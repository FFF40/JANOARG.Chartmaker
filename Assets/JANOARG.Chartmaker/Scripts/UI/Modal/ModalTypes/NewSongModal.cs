    ...
    public class NewSongModal : Modal
    {
        ...
        public void InitForm()
        {
            ...
            OnMetadataRead = (SongMetadata) =>
            {
                ...
                UnityEngine.Debug.Log("attachment count = " + SongMetadata.Attachments.Count);
        ...
        public IEnumerator ExecuteRoutine() {
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.SetSong(InitialValues);
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ActionLabel.text = "Creating Playable Song...";
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ProgressLabel.text = "Creating .japs file...";
            ...
            Behaviors.Chartmaker.Chartmaker.main.StartCoroutine(Behaviors.Chartmaker.Chartmaker.main.OpenSongRoutine(task.Result + "/" + Codename + ".japs"));
            Close();
        }

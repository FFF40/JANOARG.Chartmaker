    ...
    public class FileModal : Modal
    {
        ...
        public void SetDirectory(string path)
        {
            ...
            try 
            {
                ...
                {
                    if (!Behaviors.Chartmaker.Chartmaker.Preferences.ShowHiddenFiles && (folder.Attributes & FileAttributes.Hidden) != 0) continue;
                    isHiddenEmpty = false;
                ...
                {
                    if (!Behaviors.Chartmaker.Chartmaker.Preferences.ShowHiddenFiles && (file.Attributes & FileAttributes.Hidden) != 0) continue;
                    isHiddenEmpty = false;

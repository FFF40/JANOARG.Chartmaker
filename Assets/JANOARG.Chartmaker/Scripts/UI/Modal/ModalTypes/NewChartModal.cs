...
namespace JANOARG.Chartmaker.UI.Modal.ModalTypes
{
    public class NewChartModal : Modal
    {
        ...
        public ExternalChartMeta Execute()
        {
            ...
            string path = Path.GetDirectoryName(Behaviors.Chartmaker.Chartmaker.main.CurrentSongPath) + "/" + Codename + ".jac";
            if (File.Exists(path))
            ...
            Behaviors.Chartmaker.Chartmaker.main.Save();
        ...
        public IEnumerator ExecuteRoutine() 
        {
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.SetSong(Behaviors.Chartmaker.Chartmaker.main.CurrentSong);
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ActionLabel.text = "Creating Chart...";
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ProgressLabel.text = "Creating .jac file...";
            ...
            Behaviors.Chartmaker.Chartmaker.main.StartCoroutine(Behaviors.Chartmaker.Chartmaker.main.OpenChartRoutine(task.Result));
            Close();
        }

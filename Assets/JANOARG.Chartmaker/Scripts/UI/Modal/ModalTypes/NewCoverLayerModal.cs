...
namespace JANOARG.Chartmaker.UI.Modal.ModalTypes
{
    public class NewCoverLayerModal : Modal
    {
        ...
        {
            Metadata ??= new (Path.Combine(Path.GetDirectoryName(Behaviors.Chartmaker.Chartmaker.main.CurrentSongPath), Behaviors.Chartmaker.Chartmaker.main.CurrentSong.ClipPath));
            ...
            foreach (MetadataReader.AttachmentData item in Metadata.Attachments)
                list.Items.Add(new ContextMenuListAction(item.Name, () => 
                {
                    ...
                    UnityEngine.Debug.Log(item.Data.Length + " | " + item.Data[0] + item.Data[01] + item.Data[02] + item.Data[03]);
        ...
        public IEnumerator SaveImageRoutine() {
            ...
            PlayableSong song = Behaviors.Chartmaker.Chartmaker.main.CurrentSong;
            ...
            if (Behaviors.Chartmaker.Chartmaker.main.CurrentSong.Cover.Layers.Find(x => x.Target == target) != null)
            {
                DialogModal modal = ModalHolder.main.Spawn<DialogModal>();
            ...
            try 
            {
                path = Path.Combine(Path.GetDirectoryName(Behaviors.Chartmaker.Chartmaker.main.CurrentSongPath), target);
            }
            catch (Exception e)
            {
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ActionLabel.text  = "Saving image...";
            ...
            Behaviors.Chartmaker.Chartmaker.main.LoaderPanel.ProgressLabel.text = "Saving image...";
            ...
            Task saveTask = Behaviors.Chartmaker.Chartmaker.main.SaveAsync();
            ...
            if (!saveTask.IsCompletedSuccessfully) 
            {
                ...
                UnityEngine.Debug.LogException(saveTask.Exception);

...
namespace JANOARG.Chartmaker.Constants
{
    public class Tutorials 
    {
            ...
            new Tutorial (
                ...
                new TutorialStep[] {
                    ...
                    new (
                        ...
                        () => Behaviors.Chartmaker.Chartmaker.main.CurrentSong != null,
            ...
            new Tutorial (
                ...
                new TutorialStep[] {
                    ...
                    new (
                        ...
                        () => Behaviors.Chartmaker.Chartmaker.main.CurrentChart != null,
        ...
        {
            if (Behaviors.Chartmaker.Chartmaker.main.CurrentSong != null) 
            {
                ...
                dm.SetDialog(
                    ...
                    (x) => {
                        if (x == 0) return;
                        Behaviors.Chartmaker.Chartmaker.main.DirtyModal(() => {
                            Behaviors.Chartmaker.Chartmaker.main.CloseSong();
                            start();
                        });
                    }
                );
        ...
        {
            if (Behaviors.Chartmaker.Chartmaker.main.CurrentChart == null) 
            {
                DialogModal dm = ModalHolder.main.Spawn<DialogModal>();
                dm.SetDialog(
                    "Missing Requirement", 
